...
ในโปรแกรมไฟวิ่ง 8 ดวงรุ่นที่ 2 กำหนดตัวแปร ON_time = 1000000; OFF_time = 1000000; และใส่ในฟังก์ชัน usleep() สามารถแก้ไขเวลาเปลี่ยนไฟติดไฟดับได้ที่ตัวแปร ON_time หรือ OFF_time
```c++
    #include <stdio.h>
    #include <stdbool.h>
    #include <unistd.h>
